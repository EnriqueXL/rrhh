...
@section('nav-menu')
    ...
    <a href="{{ route('employees.edit', $employee->id) }}" class="navbar-brand"><i class="fas fa-user-edit"></i></a>

    <form id="delete-form-{{ $employee->id }}" action="{{ route('employees.destroy', $employee->id) }}" method="POST" class="d-inline">
        @csrf
        @method('DELETE')
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control form-control-sm"
                        value="{{ old('nombre') }}" placeholder="Nombre" readonly>
                    @error('nombre')
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="apellido_materno" id="apellido_materno" class="form-control form-control-sm"
                        value="{{ old('apellido_materno') }}" placeholder="Apellido Materno" readonly>
...
@section('js')
    <script>
        ...
        function showStep(step) {
            ...
            //Eliminar el botón de "Siguiente" si es el último paso
            if (step === totalSteps) {
